...
# model.pct_match = ['Actual_Cash_Value_adj']
#                         #,'Odometer_Replace'
#                                 ]
...
models = [
    ModelType('10p_1m1m_no_odm_trunc',1e6,1e6,.1,['Actual_Cash_Value_adj'],True)
    ,ModelType('05p_1m1m_no_odm_trunc',1e6,1e6,.05,['Actual_Cash_Value_adj'],True)
    ,ModelType('20p_1m1m_no_odm_trunc',1e6,1e6,.2,['Actual_Cash_Value_adj'],True)
    ,ModelType('05p_1m1m_no_odm_no_trunc',1e6,1e6,.05,['Actual_Cash_Value_adj'],False)

    ,ModelType('10p_5e51m_no_odm_trunc',5e5,1e6,.1,['Actual_Cash_Value_adj'],True)
    ,ModelType('05p_5e51m_no_odm_trunc',5e5,1e6,.05,['Actual_Cash_Value_adj'],True)
    ,ModelType('20p_5e51m_no_odm_trunc',5e5,1e6,.2,['Actual_Cash_Value_adj'],True)
    ,ModelType('05p_5e51m_no_odm_no_trunc',5e5,1e6,.05,['Actual_Cash_Value_adj'],False)


    ,ModelType('10p_1m1m_with_odm_trunc',1e6,1e6,.1,['Actual_Cash_Value_adj','Odometer_Replace'],True)
    ,ModelType('05p_1m1m_with_odm_trunc',1e6,1e6,.05,['Actual_Cash_Value_adj','Odometer_Replace'],True)
    ,ModelType('20p_1m1m_with_odm_trunc',1e6,1e6,.2,['Actual_Cash_Value_adj','Odometer_Replace'],True)

    ,ModelType('10p_500k1m_with_odm_trunc',5e5,1e6,.1,['Actual_Cash_Value_adj','Odometer_Replace'],True)
    ,ModelType('05p_500k1m_with_odm_trunc',5e5,1e6,.05,['Actual_Cash_Value_adj','Odometer_Replace'],True)
    ,ModelType('20p_500k1m_with_odm_trunc',5e5,1e6,.2,['Actual_Cash_Value_adj','Odometer_Replace'],True)

    ,ModelType('10p_500k1m_with_odm_trunc',5e5,1e6,.1,['Actual_Cash_Value_adj','Odometer_Replace'],False)
    ,ModelType('05p_500k1m_with_odm_trunc',5e5,1e6,.05,['Actual_Cash_Value_adj','Odometer_Replace'],False)
    ,ModelType('20p_500k1m_with_odm_trunc',5e5,1e6,.20,['Actual_Cash_Value_adj','Odometer_Replace'],False)
...
for id, model in enumerate(models):
    ...
    if model.truncated:
        car_demo_joined = car_demo_joined.loc[car_demo_joined[model.pct_match[0]] < car_demo_joined[model.pct_match[0]].quantile(0.99) ]
    ...
    expected_match_diff = expected_mean.Actual_Cash_Value_adj.diff().dropna()
